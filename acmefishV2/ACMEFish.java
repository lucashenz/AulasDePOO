...
public class ACMEFish {
    ...
    private void menu() {
        ...
        System.out.println("[4] Adcionar um cliente");
        System.out.println("[5] Adicionar uma compra de peixe");
        System.out.println("[6] Consultar compras por cliente");
    }
    ...
    public void adicionarClinete() {
        System.out.println("Qual o nome do clinete?");
        String nome = entrada.nextLine();
        Cliente cliente = new Cliente(nome);
        clientela.adicionarCliente(cliente);
    }
    public void cadastrarCompraDePeixe() {
        System.out.println("Qual a especie do peixe?");
        String especie = entrada.nextLine();
        System.out.print("Quantos peixes deseja adicionar? ");
        int peixes = entrada.nextInt();
    }

    public void consultarComprasPorCliente() {
        System.out.println("Consultar compras por cliente");
        System.out.println("----------------------");
